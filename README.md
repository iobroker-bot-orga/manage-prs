...
* (@claude) **CHANGED**: Renamed template `X0000-UpdateIobrokerTesting` to `X0000-updateIobrokerTesting` (lowercase `u`) for naming consistency.
...
* (@copilot) **NEW**: Added template `W1078-removeCommonMaterialize` to remove deprecated `common.materialize`, align `common.adminUI.config`, and update js-controller requirements when needed.
